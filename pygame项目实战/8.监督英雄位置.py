...
# 绘制窗口背景
# 1. 加载图像数据
bg = pygame.image.load("基本编程语法学习笔记/pygame项目实战/images/background.png") # 加载背景图像
# 2. blit 绘制图像
...
# 绘制英雄的飞机
hero = pygame.image.load("基本编程语法学习笔记/pygame项目实战/images/me1.png") # 加载英雄飞机图像
...
while True:
    ...
    #每次循环都要先重绘制背景图像
    screen.blit(bg, (0, 0)) # 将背景图像绘制到窗口上，坐标为(0, 0)
    screen.blit(hero, hero_rect) # 将背景图像绘制到窗口上，坐标为(x, y)
